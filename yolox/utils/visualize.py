...
def plot_tracking(image, tlwhs, obj_ids, scores=None, frame_id=0, play_num=0, fps=0., ids2=None,
                  court=None):
    ...
    for i, tlwh in enumerate(tlwhs):
        ...
        cv2.putText(im, id_text, (intbox[0], intbox[1]), cv2.FONT_HERSHEY_PLAIN, text_scale,
                    (0, 0, 255),
