...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.root = cfg.fullcourt_root  # '/mnt/g/data/vball/fullcourt'
        self.exp_name = os.path.split(os.path.realpath(__file__))[1].split(".")[0]
        self.train_ann = os.path.join(self.root, "trn_v4.json")
        self.val_ann = os.path.join(self.root, "val_v4.json")
        self.input_size = (800, 1440)
        self.test_size = (800, 1440)
        self.random_size = (18, 32)
        self.max_epoch = 24  # 80
        self.print_interval = 20
        self.eval_interval = 1  # 5
        self.test_conf = 0.1
        self.nmsthre = 0.7
        self.no_aug_epochs = 10
        self.basic_lr_per_img = 0.002 / 64.0  # 0.001 / 64.0
