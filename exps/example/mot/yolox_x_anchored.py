...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.root = '/mnt/g/data/vball/anchored_touch'
        self.exp_name = os.path.split(os.path.realpath(__file__))[1].split(".")[0]
        self.train_ann = os.path.join(self.root, "v1_trn.json")
        self.val_ann = os.path.join(self.root, "v1_val.json")
